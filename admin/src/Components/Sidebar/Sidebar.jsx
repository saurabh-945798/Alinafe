...
const AdminSidebar = () => {
  ...
  const handleLogout = async () => {
    const confirm = await Swal.fire({
      title: "Logout?",
      text: "You’ll be logged out from Alinafe Admin Panel!",
      icon: "warning",
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-50 lg:hidden bg-[#009688] text-white p-2 rounded-lg shadow-md"
      >
        <Menu size={22} />
      </button>
      ...
      <motion.aside
        ...
        className="h-screen fixed left-0 top-0 z-50 
          bg-gradient-to-br from-white via-[#E0F2F1] to-[#B2DFDB]
          shadow-xl text-[#004D40] flex flex-col 
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-4 border-b border-gray-200/70">
          ...
          >
            <div className="w-9 h-9 bg-[#009688]/20 rounded-lg flex items-center justify-center shadow">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="#009688"
                viewBox="0 0 24 24"
                className="w-7 h-7 transform scale-x-[-1]"
              >
            ...
            {open && (
              <div>
                ...
                <p className="text-xs text-[#009688] font-semibold -mt-1 ml-1">
                  Alinafe Panel
                </p>
              </div>
            )}
          ...
          <button
            ...
            className="text-[#004D40]/70 hover:text-[#004D40]"
          >
            ...
            menu.dropdown ? (
              <div key={menu.name}>
                <button
                  ...
                  className="flex items-center justify-between w-full p-2 rounded-lg hover:bg-[#009688]/10"
                >
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex items-center gap-3 p-2 rounded-lg ${
                    isActive ? "bg-[#009688]/20" : "hover:bg-[#009688]/10"
                  }`
                }
              >
                {menu.icon}
        ...
        <button
          ...
          className="flex items-center gap-3 mb-3 mx-3 p-2 rounded-lg hover:bg-[#009688]/10"
        >
          <LogOut size={20} />

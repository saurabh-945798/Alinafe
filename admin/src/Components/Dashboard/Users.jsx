...
const Users = () => {
  ...
  const handleStatusChange = async (id, name, status) => {
    Swal.fire({
      ...
      confirmButtonColor: status === "Suspended" ? "#d32f2f" : "#009688",
    }).then(async (result) => {
  ...
  return (
    <section className="p-6 md:p-10 bg-gradient-to-br from-[#E0F2F1] via-white to-[#F1F8E9] min-h-screen font-[Poppins]">
      {/* HEADER */}
      <motion.div
        ...
        className="mb-10"
      >
        <h1 className="text-4xl font-extrabold text-[#004D40] mb-2 flex items-center gap-2">
      ...
      <div className="flex justify-start mb-6">
        <div className="flex items-center gap-2 bg-white/70 backdrop-blur-xl px-4 py-3 rounded-xl shadow-lg border border-[#009688]/20 w-full md:w-80">
      ...
      {/* USERS TABLE */}
      <div className="overflow-x-auto bg-white/80 backdrop-blur-xl rounded-3xl shadow-lg border border-[#009688]/10">
            ...
            {loading ? (
              ...
              filteredUsers.map((user, idx) => (
                <motion.tr
                  ...
                  className="border-b hover:bg-[#E0F2F1]/40 transition"
                >
                  <td className="p-4 font-medium text-gray-800">
                    <div className="flex items-center gap-3">
                      {user.photoURL?.includes("res.cloudinary.com") ? (
                        ...
                        <div className="w-11 h-11 rounded-full bg-[#009688]/20 text-[#004D40] flex items-center justify-center font-bold">
                          {(user.name || "U")
                            .split(" ")
                            .map((n) => n[0])
                            .join("")
                  ...
                  <td className="p-4 flex gap-2">
                    <button
                      className="px-3 py-1 bg-[#E0F7FA] text-[#00695C] rounded-lg hover:bg-[#B2DFDB] flex items-center gap-1 text-sm"
        ...
        {selectedUser && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1 }}
              exit={{ scale: 0.9 }}
              className="bg-white/90 backdrop-blur-xl w-[90%] max-w-md rounded-2xl shadow-2xl p-6 relative border border-[#009688]/20"
            >
              <button
              ...
              <div className="flex flex-col items-center text-center space-y-3">
                ...
                <div className="w-full text-left space-y-2 mt-4">
                  <p className="flex items-center gap-2 text-[#004D40]">
                    <MapPin size={16} />{" "}

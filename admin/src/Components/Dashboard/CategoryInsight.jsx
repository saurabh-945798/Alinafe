...
const CategoryInsight = () => {
  ...
  if (loading || !data) {
    return (
      <div className="h-screen flex justify-center items-center text-[#00695C] font-semibold text-lg">
        Loading insights...
      </div>
    );
  }
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-[#E0F2F1] via-white to-[#F1F8E9] py-10 px-6 font-[Poppins]">
      <motion.div
      ...
      >
        ...
        <div className="flex items-center justify-between mb-12">
          <div className="flex items-center gap-4">
            ...
            >
              <ArrowLeft className="text-[#004D40]" size={20} />
            </button>

            <div>
              <h1 className="text-4xl font-extrabold text-[#004D40] tracking-tight">
                Category Insights
              </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-14">
          ...
          <motion.div
            ...
            className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl p-6 border border-teal-800/10"
          >
            <div className="flex items-center gap-3 mb-5">
              <div className="p-2 bg-[#009688]/10 rounded-xl border border-[#009688]/20">
                <BarChart3 className="text-[#00695C]" size={22} />
              </div>
                ...
                data={{
                  ...
                  datasets: [
                    ...
                    },
                    {
                      ...
                      type: "line",
                      borderColor: "#004D40",
                      backgroundColor: "rgba(0,100,80,0.12)",
                      yAxisID: "y1",
                      tension: 0.4,
                      borderWidth: 2,
                    },
          ...
          <table className="min-w-full text-left">
            ...
            <tbody>
              {insights.map((cat, i) => (
                <motion.tr
                  key={i}
                  whileHover={{ backgroundColor: "rgba(0,150,136,0.05)" }}
                  className="border-b text-gray-700"
                >
                  <td className="px-4 py-3 font-semibold text-[#004D40]">
                    {cat.category}
                  </td>
                  <td className="px-4 py-3">{cat.totalAds}</td>
                  <td className="px-4 py-3 text-[#009688]">
        ...
        <div className="text-center text-gray-500 text-sm mt-10">
          ...
          <b className="text-[#00695C]">Alinafe Admin</b> — Premium Category
          Analytics
        </div>
      </motion.div>
    </section>

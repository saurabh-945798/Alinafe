      ...
      >
        ...
        <div className="flex items-center justify-between mb-12">
          <div className="flex items-center gap-4">
            ...
            >
              <ArrowLeft size={22} className="text-[#004D40]" />
            </button>
          ...
          {[
            {
              title: "Total Users",
              value: totalUsers,
              icon: <Users className="text-[#00796B]" size={24} />,
              color: "from-[#B2DFDB] to-[#E0F2F1]",
            },
            {
              title: "Growth Rate",
              value: userGrowthRate + "",
              icon: <TrendingUp className="text-[#2E7D32]" size={24} />,
              color: "from-[#C8E6C9] to-[#E8F5E9]",
            },
            {
              title: "Active Users",
              value: Math.round(totalUsers * 0.75),
              icon: <UserCheck className="text-[#F9A825]" size={24} />,
              color: "from-[#FFF9C4] to-[#FFFDE7]",
            },
            {
              title: "Top Location",
              value: userCities[0]?._id || "—",
              icon: <MapPin className="text-[#D32F2F]" size={24} />,
              color: "from-[#FFCDD2] to-[#FFEBEE]",
            },
          ].map((card, idx) => (
            <motion.div
              key={idx}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-16">
          <motion.div className="bg-white/80 rounded-3xl p-6 shadow-xl border">
            <h3 className="font-semibold text-[#004D40] mb-4">
              Monthly User Growth
            </h3>
            <div className="h-72">
              <Line
          ...
          <motion.div className="bg-white/80 rounded-3xl p-6 shadow-xl border">
            <h3 className="font-semibold text-[#00695C] mb-4">
              Top User Locations
            </h3>
            <div className="h-72">
              <Bar
        ...
        >
          <h2 className="text-2xl font-bold text-[#004D40] mb-6 flex items-center gap-2">
            <ShieldCheck className="text-[#0E9F9F]" />
            Top Active Sellers
          </h2>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {topActiveSellers.map((u, i) => (
                  <tr
                    key={i}
                    className="border-b hover:bg-[#F1F8F7] transition"
                  >
                    ...
                    <td className="font-semibold text-[#00796B]">
                      {u.totalAdsPosted}
                    </td>
                    <td>
                      {u.isActiveSeller ? (

...
const AdminReports = () => {
  ...
  ===================================================== */
  return (
    <section className="min-h-screen bg-gradient-to-br from-[#E0F2F1] via-white to-[#F1F8E9] py-8 px-6 font-[Poppins]">
      {/* STICKY TOOLBAR */}
      <div className="sticky top-0 z-30 bg-white/80 backdrop-blur border border-[#009688]/20 mb-6 rounded-xl px-4 py-3 shadow-sm">
        <div className="flex flex-col lg:flex-row gap-4 lg:items-center justify-between">
          <h1 className="text-2xl font-extrabold text-[#004D40] flex items-center gap-2">
            <FileText size={22} className="text-[#009688]" />
            Reports
          </h1>
          ...
          {reports.map((r, i) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className={`bg-white rounded-2xl shadow-lg border border-[#009688]/20 p-4 space-y-3 ${meta.glow}`}
              >
                {/* TITLE */}
                <p className="font-bold text-[#004D40] leading-snug">
                  {r.adTitle}
                </p>
                ...
                <div className="flex items-center justify-between">
                  ...
                  {r.fileUrl && (
                    <button
                      ...
                      className="text-[#009688] text-xs flex items-center gap-1"
                    >
                ...
                <div className="flex gap-2 pt-2">
                  <button
                    ...
                    className="flex-1 bg-[#009688] text-white rounded-xl py-2 text-sm font-semibold"
                  >
                    View Report
                  </button>
      ...
      <AnimatePresence>
        {proofUrl && (
          ...
          >
            ...
            >
              <h3 className="text-lg font-bold text-[#004D40] mb-3">
                Proof Attachment
              </h3>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-4 inline-block bg-[#009688] text-white px-4 py-2 rounded-xl text-sm font-semibold"
              >
                Open Proof
              </a>
            </motion.div>

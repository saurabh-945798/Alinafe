  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      <motion.h1
        ...
        className="text-3xl font-bold text-[#0E9F9F] mb-8"
      >
        Admin Settings
      </motion.h1>
      ...
      >
        ...
        <div className="flex items-center gap-6 mb-6">
          <div className="relative">
            ...
            <label
              htmlFor="photoInput"
              className="absolute bottom-0 right-0 bg-[#0E9F9F] p-2 rounded-full text-white cursor-pointer hover:bg-[#0B7C7C]"
            >
              <Camera size={18} />
            </label>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full px-4 py-2 bg-gray-50 rounded-lg border border-gray-200 focus:ring-2 focus:ring-[#0E9F9F]"
          />
        </div>
      ...
      <motion.button
        whileTap={{ scale: 0.95 }}
        onClick={handleSave}
        className="mt-6 w-full bg-[#0E9F9F] text-white py-3 rounded-xl shadow-md font-semibold flex items-center justify-center gap-2 hover:bg-[#0B7C7C]"
      >

...
const Sidebar = () => {
  ...
  const handleLogout = async () => {
    const confirm = await Swal.fire({
      title: "Logout?",
      text: "You’ll be logged out from Alinafe!",
      icon: "warning",
  ...
  return (
    <>
      ...
      <motion.aside
        ...
        bg-gradient-to-br from-white via-[#E6F6F4] to-[#CDEEE9]
        border-r border-[var(--border)]
        shadow-[var(--shadow)]
        flex flex-col text-[#004D40] font-[Poppins]"
      >
        {/* BRAND ZONE */}
        <div className="px-4 pt-6 pb-4 border-b border-[var(--border)]">
          ...
          >
            <svg viewBox="0 0 24 24" fill="#009688" className="w-7 h-7">
            ...
            {(open || isMobile) && (
              <div className="leading-tight">
                ...
                <p className="text-[11px] text-[#009688]">
          ...
          <button
            ...
            className="absolute top-5 right-4 text-[#004D40]/70 focus:outline-none"
          >
            <X size={18} />
          </button>
        </div>
            ...
            menu.dropdown ? (
              <div key={menu.name}>
                <button
                  ...
                  className="w-full flex items-center justify-between px-2 py-2 rounded-lg hover:bg-[#009688]/10"
                >
                  ...
                  {menu.name === "My Ads" && adsOpen && (open || isMobile) && (
                    <motion.div className="ml-8 mt-2 space-y-1">
                      <NavLink
                        ...
                        className="block text-sm px-2 py-1 rounded hover:bg-[#009688]/10"
                      >
                        My Ads
                      </NavLink>
                      <NavLink
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  ...
                  ${
                    isActive
                      ? "bg-[#009688]/10 before:absolute before:left-0 before:top-1 before:bottom-1 before:w-[3px] before:rounded-full before:bg-gradient-to-b before:from-[#009688] before:to-[#4DB6AC]"
                      : "hover:bg-[#009688]/10"
                  }`
                }
              >
        ...
        {(open || isMobile) && (
          <div className="px-3 pb-4 border-t border-[var(--border)]">
            <button
              ...
              className="w-full flex items-center gap-3 px-2 py-2 rounded-lg hover:bg-[#009688]/10"
            >
              <LogOut size={18} />

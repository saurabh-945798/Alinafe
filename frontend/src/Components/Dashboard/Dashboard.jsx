...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        if (!token) {
          console.error("Firebase token missing");
          return;
        }
        ...
        const adsReq = axios.get(`${API_BASE}/ads/user/${user.uid}`, config);
  
        const favReq = axios.get(`${API_BASE}/favorites/${user.uid}`, config);
  
        // ❌ CHAT API abhi backend me nahi hai
        // const chatReq = axios.get(
        //   `${BASE_URL}/api/chats/user/${user.uid}`,
        //   config
        // );
  ...
  // keep your old Messages=5 (static)
    ...
    () => [
      {
        ...
        gradient: "from-[#00bfa5] via-[#009688] to-[#00796B]",
      ...
      },
      {
        ...
        gradient: "from-[#4dd0e1] via-[#00acc1] to-[#00838f]",
        sub: "New chats",
      },
      {
        title: "Favorites",
        ...
        gradient: "from-[#ff5fa2] via-[#f06292] to-[#ec407a]",
        sub: "Saved items",
      },
      {
        title: "Total Views",
        ...
        gradient: "from-[#ffd180] via-[#ffb74d] to-[#fb8c00]",
        sub: "Across your ads",
      },
    ],
      ...
      <div className="min-h-screen bg-[#F6FBFA] flex items-center justify-center">
        <div className="relative w-full max-w-sm px-6">
          <div className="absolute inset-0 -z-10 blur-3xl opacity-70">
            <div className="w-64 h-64 rounded-full bg-[#009688]/25 absolute -top-16 -left-10" />
            <div className="w-72 h-72 rounded-full bg-[#80CBC4]/25 absolute -bottom-16 -right-10" />
          </div>

          <div className="bg-white/70 backdrop-blur-xl border border-white/50 rounded-3xl p-6 shadow-xl">
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-[#009688] to-[#00796B] shadow-lg shadow-[#009688]/30" />
              <div className="flex-1">
                <p className="text-sm text-gray-500">Loading</p>
                <p className="text-base font-semibold text-[#00695C]">
                  Your Dashboard…
                </p>
              </div>
            </div>
            <div className="mt-5 h-2 rounded-full bg-gray-100 overflow-hidden">
              <motion.div
                className="h-full w-1/2 bg-gradient-to-r from-[#009688] to-[#00796B]"
                initial={{ x: "-50%" }}
                animate={{ x: "150%" }}
  ...
  const statusBadgeClass = (status) => {
    ...
    return "bg-[#E0F2F1] text-[#004D40]";
  };

  return (
    <div className="flex min-h-screen bg-[#F6FBFA] font-[Poppins] text-gray-800">
      {/* ✅ Sidebar */}
      {/* <Sidebar /> */}
      ...
      <div className="flex-1 lg:ml-64 relative overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -top-20 -right-32 w-[520px] h-[520px] bg-[#009688]/18 rounded-full blur-3xl" />
          <div className="absolute bottom-[-140px] left-[-120px] w-[520px] h-[520px] bg-[#80CBC4]/18 rounded-full blur-3xl" />
          ...
          <div className="bg-white/65 backdrop-blur-xl border-b border-white/50">
            <div className="px-4 sm:px-6 md:px-8 py-5 flex flex-col gap-4">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                  <div className="inline-flex items-center gap-2 text-xs px-3 py-1 rounded-full bg-[#E0F2F1] text-[#00695C] border border-white/60">
                    <Sparkles className="w-4 h-4" />
                    Alinafe Dashboard
                  </div>
                  <h1 className="mt-2 text-2xl sm:text-3xl font-semibold text-[#004D40] tracking-tight">
                    Welcome, {user?.displayName || "User"}
                  </h1>
                  <p className="text-sm text-gray-600 mt-1">
                    Your insights and recent activity at a glance.
                  </p>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    <CalendarDays className="w-4 h-4 text-[#009688]" />
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="flex items-center gap-2 bg-gradient-to-r from-[#009688] to-[#00796B] text-white rounded-full px-5 py-2.5 shadow-lg shadow-[#009688]/25 hover:shadow-xl transition"
                ...
                <div className="flex-1">
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="Search your ads by title, description, city, category…"
                      className="w-full pl-11 pr-4 py-3 rounded-2xl bg-white/70 backdrop-blur-md border border-white/60 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#009688]/30"
                    />
                  </div>
                </div>
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-full text-sm font-medium border transition ${
                        activeTab === t.key
                          ? "bg-[#009688] text-white border-[#009688] shadow-md shadow-[#009688]/20"
        ...
        <div className="relative z-10 px-4 sm:px-6 md:px-8 py-8 space-y-10">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <Card className="xl:col-span-2 shadow-xl border border-white/50 bg-white/60 backdrop-blur-xl rounded-3xl overflow-hidden">
              <CardHeader className="px-6 pt-6 pb-4">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    <h2 className="text-xl font-semibold text-[#004D40] flex items-center gap-2">
                      🛍️ Your Recent Ads
                    </h2>
                    <p className="text-sm text-gray-600 mt-1">
                  ...
                  <Button
                    variant="outline"
                    className="border-[#009688] text-[#009688] rounded-full px-4 hover:bg-[#E0F2F1]"
                    onClick={() => navigate("/dashboard/my-ads")}
                  >
                    View All
                  </Button>
              ...
              <CardContent className="px-6 pb-6">
                {recentAds.length > 0 ? (
                      ...
                      >
                        ...
                        <div className="p-4">
                          ...
                          <div className="mt-4 flex items-center justify-between">
                            <Button
                              variant="outline"
                              className="text-xs rounded-full px-3 border-[#009688] text-[#009688] hover:bg-[#E0F2F1]"
                            ...
                            <Button
                              className="text-xs rounded-full px-3 bg-[#009688] hover:bg-[#00796B] text-white"
                  ...
                  <div className="flex flex-col items-center justify-center py-14">
                    ...
                    <Button
                      className="mt-5 rounded-full bg-[#009688] hover:bg-[#00796B] text-white"
                      onClick={() => navigate("/dashboard/createAd")}
                    >
            ...
            <div className="space-y-6">
              {/* Quick Actions */}
              <Card className="p-6 rounded-3xl bg-gradient-to-br from-[#009688] to-[#00796B] text-white shadow-xl border border-white/20">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 xl:grid-cols-1 gap-3">
                  <motion.button
                    whileTap={{ scale: 0.97 }}
                    onClick={() => navigate("/dashboard/createAd")}
                    className="bg-white text-[#009688] rounded-2xl shadow-md px-5 py-3 font-semibold hover:bg-[#E0F2F1] flex items-center justify-between"
                  >
                    Post Ad
              ...
              {/* Compact “All Ads” Preview (advanced) */}
              <Card className="rounded-3xl shadow-xl border border-white/50 bg-white/60 backdrop-blur-xl overflow-hidden">
                <CardHeader className="px-6 pt-6 pb-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge className="rounded-full bg-[#E0F2F1] text-[#004D40] px-3 py-1">
                ...
                <CardContent className="px-6 pb-6">
                  {filteredAds.length > 0 ? (
                        ...
                        >
                          ...
                          <div className="flex flex-col items-end gap-1">
                            ...
                            <span className="text-xs text-gray-500 inline-flex items-center gap-1">
                              <Eye className="w-3.5 h-3.5 text-[#009688]" />
                              {ad.views || 0}
                            </span>
                          </div>
                        </button>
                    ...
                    <div className="py-10 text-center">
                      ...
                      <Button
                        variant="outline"
                        className="mt-4 rounded-full border-[#009688] text-[#009688] hover:bg-[#E0F2F1]"
                        onClick={() => {
                          setQuery("");
                          setActiveTab("all");
                        }}
            ...
            <Dialog open={!!selectedAd} onOpenChange={() => setSelectedAd(null)}>
              <DialogContent className="max-w-2xl bg-white rounded-3xl shadow-2xl p-0 overflow-hidden border border-white/50">
                <DialogHeader className="px-6 pt-6 pb-3">
                  <DialogTitle className="text-[#004D40] font-semibold flex items-center justify-between gap-3">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <Button
                      className="w-full bg-[#009688] hover:bg-[#00796B] text-white rounded-2xl"

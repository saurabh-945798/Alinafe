...
import { getCitiesForState } from "../../Data/indiaCities";
...
const CreateAdForm = ({
  ...
  const sparePartsFields = [
  {
    name: "partCategory",
    placeholder: "Part Category",
    type: "select",
    options: ["Engine", "Brake", "Body", "Suspension", "Electrical", "Other"],
  },
  {
    name: "originalType",
  ...
  },
    {
      ...
      type: "select",
      options: ["Working", "Small Issue"],
    },
  ];



  const vehicleAccessoriesFields = [
    {
      name: "accessoryType",
      placeholder: "Accessory Type",
      type: "select",
      options: ["Interior", "Exterior", "Electronics", "Safety", "Lighting", "Other"],
    },
    {
      name: "vehicleType",
      placeholder: "Vehicle Type",
      type: "select",
      options: ["Car", "Bike", "Scooter", "Truck", "Universal"],
    },
  ...
  const uniqueStates = [...new Set(indianStates)];
  const uniqueCities = [...new Set(getCitiesForState(form.state))];
  ...
  return (
    <div className="flex-1 lg:ml-64 min-h-screen bg-[#F9FAFB] px-4 sm:px-6 md:px-10 py-8">
      ...
      >
        {/* HEADER */}
        <div className="mb-10">
          <h1 className="text-3xl font-bold text-[#009688]">Post New Ad</h1>
        ...
        <div className="mb-14">
          <div className="flex items-center justify-between relative">
            ...
            <div
              className="absolute top-5 left-0 h-[3px] bg-[#009688] rounded-full transition-all duration-500"
              style={{
                  ...
                  <div
                    ...
                    ${
                      completed
                        ...
                        : active
                        ? "bg-white border-[#009688] text-[#009688] scale-110 shadow-md"
            ...
            {step === 1 && (
              ...
              >
                ...
                {form.category === "Vehicles" &&
                  form.subcategory?.toLowerCase().includes("accessories") && (
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      {vehicleAccessoriesFields.map((f) =>
                        f.type === "select" ? (
                          <Select
                            key={f.name}
                            label={f.placeholder}
                ...
                {!["Jobs", "Pets", "Services"].includes(form.category) && (
  ...
  <motion.div key="step2" className="space-y-8">
    ...
    <div className="grid gap-6 lg:grid-cols-2">
      {/* IMAGE UPLOAD */}
      <div className="border-2 border-dashed border-[#009688] rounded-2xl p-10 text-center bg-[#F8FAFC] min-h-[220px] flex flex-col items-center justify-center">
        <Upload size={32} className="mx-auto text-[#009688]" />
        ...
        <label
          ...
          className={`inline-flex items-center justify-center mt-4 px-7 py-2.5 text-sm font-semibold rounded-xl shadow-sm ${
            preview.length >= 5
              ...
              : "bg-[#009688] text-white cursor-pointer"
          }`}
        >
          Choose Images
        </label>
      ...
      <div className="border-2 border-dashed border-[#009688] rounded-2xl p-10 text-center bg-[#F8FAFC] min-h-[220px] flex flex-col items-center justify-center">
        ...
        {!videoPreview && (
          <>
            ...
            <label
              htmlFor="videoUpload"
              className="inline-flex items-center justify-center gap-2 px-7 py-2.5 text-sm font-semibold bg-[#009688] text-white rounded-xl cursor-pointer shadow-sm"
            >
              <Upload size={18} />
              Choose Video
            </label>
          ...
          <div className="flex justify-between mt-12">
            ...
            {step < 3 ? (
              <button
                type="button"
                onClick={handleNext}
                className="ml-auto px-6 py-2 bg-[#009688] text-white rounded-xl"
              >
                Next
              </button>
            ) : (
              <button
                type="submit"
                disabled={uploading}
                className="ml-auto px-6 py-2 bg-[#009688] text-white rounded-xl flex items-center gap-2"
              >

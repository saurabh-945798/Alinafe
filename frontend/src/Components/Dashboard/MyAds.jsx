...
const MyAds = () => {
  ...
  if (loading)
    return (
      <div className="flex items-center justify-center h-screen text-[#009688] text-lg font-semibold">
  ...
  return (
    <div className="flex h-screen overflow-hidden font-[Poppins] bg-gradient-to-br from-[#E0F2F1] via-[#F1F8F6] to-[#ffffff] text-gray-800 relative">
      {/* Background glow blobs */}
      <div className="absolute -top-20 right-[-8rem] w-96 h-96 bg-[#009688]/20 rounded-full blur-3xl"></div>
      <div className="absolute bottom-[-6rem] left-[-5rem] w-72 h-72 bg-[#80CBC4]/30 rounded-full blur-3xl"></div>
      ...
      <main className="flex-1 lg:ml-64 overflow-y-auto overflow-x-hidden no-scrollbar p-8 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
          <div>
            <motion.h1
              ...
              className="text-3xl font-semibold bg-gradient-to-r from-[#009688] to-[#00796B] bg-clip-text text-transparent"
            >
              Manage Your Ads ✨
            </motion.h1>
          ...
          <Button
            ...
            className="flex items-center gap-2 bg-gradient-to-r from-[#009688] to-[#00796B] hover:scale-105 transition-transform text-white rounded-full px-5 py-2 shadow-md"
          >
            ...
            <motion.button
              ...
              className={`px-4 py-1.5 rounded-full border text-sm font-medium transition-all ${
                filter === status
                  ...
                  : "border-[#009688] text-[#009688] hover:bg-[#E0F2F1]"
              }`}
            >
              {status}
            </motion.button>
        ...
        {filteredAds.length === 0 ? (
          ...
          >
            ...
            <Button
              onClick={() => navigate("/dashboard/createAd")}
              className="bg-[#009688] hover:bg-[#00796B] text-white rounded-full px-5 py-2"
            >
              ...
              >
                <Card className="group overflow-hidden border border-white/50 shadow-md hover:shadow-2xl transition-all rounded-3xl bg-white/80 backdrop-blur-md">
                  ...
                  <CardContent className="p-5">
                    <h3 className="text-lg font-semibold text-[#00796B] mb-1 line-clamp-1">
                      {ad.title}
                    </h3>
                    ...
                    {ad.price && (
                      <p className="text-[#009688] font-semibold text-lg mb-2">
          ...
          {editingAd && (
            <Dialog open={!!editingAd} onOpenChange={() => setEditingAd(null)}>
              <DialogContent className="max-w-lg bg-white rounded-3xl shadow-xl border border-gray-100 p-6">
                <DialogHeader>
                  <DialogTitle className="text-[#009688] text-xl font-semibold">
                    ✏️ Edit Ad Details
                  </DialogTitle>
                </DialogHeader>
                <form onSubmit={handleUpdateAd} className="space-y-4 mt-3">
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-gradient-to-r from-[#009688] to-[#00796B] text-white font-semibold rounded-full mt-3 hover:scale-[1.02] transition-transform"
                  >
                    Save Changes
                  </Button>
                </form>

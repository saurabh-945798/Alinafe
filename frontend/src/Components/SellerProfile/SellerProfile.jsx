...
const SellerProfile = () => {
    ...
    const fetchSellerData = async () => {
      try {
        ...
        const adsRes = await axios.get(
          `${API_BASE}/public/sellers/${sellerId}/ads`
        );
        ...
        setSeller({
          ...
          joinedAt: new Date(firstAd.createdAt).toLocaleDateString("en-IN", {
            month: "short",
            year: "numeric",
          }),
  ...
  const trustBadges = useMemo(() => {
    ...
    if (seller.verified) {
      badges.push({
        ...
        label: "Verified",
        icon: BadgeCheck,
        tone: "text-[#0B4F4A] bg-[#0F766E]/10 border-[#0F766E]/20",
        dot: "bg-[#14B8A6]", // tiny gold highlight
      });
    }
  ...
  ---------------------------------- */
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#ECFEFF] via-white to-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-6 pb-24">
        {/* 🔙 Back */}
        <button
          onClick={() => navigate(-1)}
          className="flex items-center gap-2 text-gray-600 hover:text-[#0F766E] mb-6"
        >
          <ArrowLeft size={18} />
          Back
        </button>
        ...
        <div className="relative overflow-hidden rounded-3xl border bg-white shadow-sm">
          {/* soft blue gradient */}
          <div className="absolute inset-0 bg-gradient-to-br from-[#0F766E]/15 via-white to-[#0F766E]/5" />
          {/* subtle pattern */}
          <div
          ...
          />
          {/* glow blobs */}
          <div className="absolute -top-16 -left-16 w-72 h-72 bg-[#0F766E]/15 blur-3xl rounded-full" />
          <div className="absolute -bottom-16 -right-16 w-72 h-72 bg-[#0F766E]/10 blur-3xl rounded-full" />

          <div className="relative px-4 sm:px-6 pt-7 sm:pt-10 pb-8">
            <div className="flex items-center justify-between gap-4">
              <div className="text-[#0B4F4A]">
                <p className="text-sm font-medium opacity-80">Seller Profile</p>
                <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">
                  {seller.name}
                </h1>
                {seller.city ? (
                  <p className="mt-2 inline-flex items-center gap-2 text-sm text-[#0B4F4A]/80">
                ...
                <div className="rounded-2xl border border-white/40 bg-white/35 backdrop-blur-xl shadow-lg px-4 py-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="leading-tight">
                      <p className="font-semibold text-[#0B4F4A] line-clamp-1">
                        {seller.name}
                      </p>
                      <p className="text-xs text-[#0B4F4A]/70">
                        Alinafe Seller
                      </p>
                    </div>
                  </div>
              ...
              <div className="rounded-2xl border border-white/40 bg-white/35 backdrop-blur-xl shadow-lg px-4 py-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="leading-tight">
                    ...
                    {seller.city ? (
                      <p className="mt-1 inline-flex items-center gap-2 text-xs text-[#0B4F4A]/70">
                        <MapPin size={14} className="text-[#0F766E]" />
                        {seller.city}
                      </p>
                    ) : (
                      <p className="text-xs text-[#0B4F4A]/70">Alinafe  Seller</p>
                    )}
                  </div>
                </div>
              </div>
            ...
            {/* subtle divider */}
            <div className="mt-7 border-t border-[#0F766E]/10" />
          </div>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5">
            <div className="bg-white border rounded-2xl shadow-sm overflow-hidden">
              <div className="p-6">
                <h2 className="text-lg font-semibold text-[#0B4F4A]">
                  About Seller
                </h2>
                ...
                <div className="mt-5 flex items-center gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-sm text-[#0B4F4A]/70">
                      Alinafe marketplace seller
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-5 space-y-2">
                  ...
                  {seller.phone && (
                    <div className="flex items-center gap-2 text-sm text-gray-700">
                      <PhoneCall size={16} className="text-[#0F766E]" />
                      {seller.phone}
                    </div>
                  )}
                ...
                {/* Seller Trust */}
                <div className="mt-6">
                  <h3 className="text-sm font-semibold text-[#0B4F4A]">
                    Seller Trust
                  </h3>
                ...
                <div className="mt-7 hidden lg:flex flex-wrap gap-3">
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 text-sm rounded-full 
                               ...
                               hover:bg-[#0F766E] hover:text-white transition"
                  >
                    <Share2 size={16} />
                    Copy Profile Link
                  </button>
              ...
              <div className="border-t bg-gradient-to-r from-[#0F766E]/5 via-white to-[#0F766E]/5 px-6 py-4">
                <p className="text-xs text-[#0B4F4A]/70">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-white border rounded-2xl shadow-sm p-4">
                <div className="flex items-center gap-3">
                  <span className="w-10 h-10 rounded-xl bg-[#0F766E]/10 flex items-center justify-center">
            ...
            <div className="bg-white border rounded-2xl shadow-sm p-6">
              <div className="flex items-end justify-between gap-4">
                ...
                <div className="hidden sm:flex items-center gap-2 text-xs text-[#0B4F4A]/70">
                  <span className="w-2 h-2 rounded-full bg-[#14B8A6]"></span>
                  Gold is used as tiny highlight only
                </div>
              </div>

              <div className="mt-5 border-t border-[#0F766E]/10" />
                ...
                <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
                  {ads.map((ad) => (
                    <div
                      ...
                      className="group cursor-pointer rounded-2xl border bg-white overflow-hidden shadow-sm hover:shadow-lg transition-all duration-200 hover:-translate-y-1 flex flex-col h-full"
                    >
                        ...
                        <div className="absolute top-3 right-3">
                          <span
                            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full 
                                       bg-white/90 text-[#0F766E] text-xs font-semibold
                                       border border-white/60 backdrop-blur
                                       group-hover:bg-[#0F766E] group-hover:text-white transition"
                          >
                            <Eye size={14} />
                            View
                          </span>
                      ...
                      <div className="p-4 flex flex-col flex-1">
                        <div className="flex items-center justify-between gap-3">
                          ...
                          <span className="text-xs px-2 py-1 rounded-full bg-[#0F766E]/10 text-[#0B4F4A] border border-[#0F766E]/15">
                            Alinafe
                          </span>
                        </div>
                        ...
                        <div className="mt-auto pt-4 flex items-center justify-between">
                          <span className="text-xs text-gray-500">
                            <span className="inline-block w-1.5 h-1.5 rounded-full bg-[#14B8A6] mr-2"></span>
                            Tap to view details
                          </span>
                        </div>
                      </div>
          ...
          <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
            ...
            <div className="relative w-full sm:max-w-md bg-white rounded-t-3xl sm:rounded-3xl border shadow-xl p-6">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <h3 className="text-lg font-semibold text-[#0B4F4A]">
                    Contact {seller.name}
                  </h3>
                  <p className="text-sm text-gray-500 mt-1">
                ...
                <button
                  onClick={() => setContactOpen(false)}
                  className="text-gray-500 hover:text-[#0F766E] text-sm font-semibold"
                >
                  Close
                </button>
              </div>
              ...
              <div className="mt-5 grid grid-cols-1 gap-3">
                {seller.phone ? (
                  <a
                    ...
                    className="flex items-center justify-between gap-3 p-4 rounded-2xl border hover:border-[#0F766E]/40 hover:bg-[#0F766E]/5 transition"
                  >
                    <div className="flex items-center gap-3">
                      <span className="w-10 h-10 rounded-xl bg-[#0F766E]/10 flex items-center justify-center">
                        <PhoneCall size={18} className="text-[#0F766E]" />
                      </span>
                      <div>
                ...
                <button
                  ...
                  className="flex items-center justify-between gap-3 p-4 rounded-2xl border hover:border-[#0F766E]/40 hover:bg-[#0F766E]/5 transition text-left"
                >
                  <div className="flex items-center gap-3">
                    <span className="w-10 h-10 rounded-xl bg-[#0F766E]/10 flex items-center justify-center">
          ...
          <div className="max-w-6xl mx-auto px-4 py-3 flex gap-3">
            <button
              ...
              className="flex-1 inline-flex items-center justify-center gap-2 py-3 rounded-2xl
                         border border-[#0F766E] text-[#0F766E] font-semibold text-sm
                         hover:bg-[#0F766E] hover:text-white transition"
            >
              <Share2 size={18} />
              Share
            ...
            <button
              onClick={() => setContactOpen(true)}
              className="flex-1 inline-flex items-center justify-center gap-2 py-3 rounded-2xl
                         bg-[#0F766E] text-white font-semibold text-sm
                         hover:bg-[#0B4F4A] transition"
            >
              <PhoneCall size={18} />
              Contact
